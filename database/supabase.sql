...
create table public.teacher_class (
  ...
  constraint teacher_class_class_id_fkey foreign KEY (class_id) references classes (id),
  constraint teacher_class_teacher_id_fkey foreign KEY (teacher_id) references users (id)
) TABLESPACE pg_default;